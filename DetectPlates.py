...
def detectPlatesInScene(imgOriginalScene):
    ...
    if numberread.showSteps == True: # show steps #######################################################
    ...
    if numberread.showSteps == True: # show steps #######################################################
        ...
        cv2.drawContours(imgContours, contours, -1, numberread.SCALAR_WHITE)
    ...
    if numberread.showSteps == True: # show steps #######################################################
        ...
        for i in range(0, len(listOfPossiblePlates)):
            ...
            cv2.line(imgContours, tuple(p2fRectPoints[0]), tuple(p2fRectPoints[1]), numberread.SCALAR_RED, 2)
            cv2.line(imgContours, tuple(p2fRectPoints[1]), tuple(p2fRectPoints[2]), numberread.SCALAR_RED, 2)
            cv2.line(imgContours, tuple(p2fRectPoints[2]), tuple(p2fRectPoints[3]), numberread.SCALAR_RED, 2)
            cv2.line(imgContours, tuple(p2fRectPoints[3]), tuple(p2fRectPoints[0]), numberread.SCALAR_RED, 2)
...
def findPossibleCharsInScene(imgThresh):
    ...
    for i in range(0, len(contours)):                       # for each contour
        ...
        if numberread.showSteps == True: # show steps ###################################################
            cv2.drawContours(imgContours, contours, i, numberread.SCALAR_WHITE)
        # end if # show steps #####################################################################
